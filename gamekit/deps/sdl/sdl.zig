...
pub const SDL_ASSERTION_RETRY = @enumToInt(enum_unnamed_16.SDL_ASSERTION_RETRY);
pub const SDL_ASSERTION_BREAK = @enumToInt(enum_unnamed_16.SDL_ASSERTION_BREAK);
...
pub const SDL_ENOMEM = @enumToInt(enum_unnamed_18.SDL_ENOMEM);
pub const SDL_EFREAD = @enumToInt(enum_unnamed_18.SDL_EFREAD);
pub const SDL_EFWRITE = @enumToInt(enum_unnamed_18.SDL_EFWRITE);
...
pub const SDL_THREAD_PRIORITY_LOW = @enumToInt(enum_unnamed_19.SDL_THREAD_PRIORITY_LOW);
...
pub const SDL_PIXELTYPE_INDEX8 = @enumToInt(enum_unnamed_29.SDL_PIXELTYPE_INDEX8);
pub const SDL_PIXELTYPE_PACKED8 = @enumToInt(enum_unnamed_29.SDL_PIXELTYPE_PACKED8);
pub const SDL_PIXELTYPE_PACKED16 = @enumToInt(enum_unnamed_29.SDL_PIXELTYPE_PACKED16);
pub const SDL_PIXELTYPE_PACKED32 = @enumToInt(enum_unnamed_29.SDL_PIXELTYPE_PACKED32);
pub const SDL_PIXELTYPE_ARRAYU8 = @enumToInt(enum_unnamed_29.SDL_PIXELTYPE_ARRAYU8);
pub const SDL_PIXELTYPE_ARRAYU16 = @enumToInt(enum_unnamed_29.SDL_PIXELTYPE_ARRAYU16);
...
pub const SDL_PACKEDORDER_NONE = @enumToInt(enum_unnamed_31.SDL_PACKEDORDER_NONE);
pub const SDL_PACKEDORDER_XRGB = @enumToInt(enum_unnamed_31.SDL_PACKEDORDER_XRGB);
pub const SDL_PACKEDORDER_RGBX = @enumToInt(enum_unnamed_31.SDL_PACKEDORDER_RGBX);
pub const SDL_PACKEDORDER_ARGB = @enumToInt(enum_unnamed_31.SDL_PACKEDORDER_ARGB);
pub const SDL_PACKEDORDER_RGBA = @enumToInt(enum_unnamed_31.SDL_PACKEDORDER_RGBA);
pub const SDL_PACKEDORDER_XBGR = @enumToInt(enum_unnamed_31.SDL_PACKEDORDER_XBGR);
...
pub const SDL_ARRAYORDER_NONE = @enumToInt(enum_unnamed_32.SDL_ARRAYORDER_NONE);
pub const SDL_ARRAYORDER_RGB = @enumToInt(enum_unnamed_32.SDL_ARRAYORDER_RGB);
pub const SDL_ARRAYORDER_RGBA = @enumToInt(enum_unnamed_32.SDL_ARRAYORDER_RGBA);
pub const SDL_ARRAYORDER_ARGB = @enumToInt(enum_unnamed_32.SDL_ARRAYORDER_ARGB);
...
pub const SDL_PACKEDLAYOUT_NONE = @enumToInt(enum_unnamed_33.SDL_PACKEDLAYOUT_NONE);
pub const SDL_PACKEDLAYOUT_332 = @enumToInt(enum_unnamed_33.SDL_PACKEDLAYOUT_332);
pub const SDL_PACKEDLAYOUT_4444 = @enumToInt(enum_unnamed_33.SDL_PACKEDLAYOUT_4444);
pub const SDL_PACKEDLAYOUT_1555 = @enumToInt(enum_unnamed_33.SDL_PACKEDLAYOUT_1555);
pub const SDL_PACKEDLAYOUT_5551 = @enumToInt(enum_unnamed_33.SDL_PACKEDLAYOUT_5551);
...
pub const SDL_PIXELFORMAT_UNKNOWN = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_UNKNOWN);
pub const SDL_PIXELFORMAT_INDEX1LSB = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_INDEX1LSB);
pub const SDL_PIXELFORMAT_INDEX1MSB = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_INDEX1MSB);
pub const SDL_PIXELFORMAT_INDEX4LSB = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_INDEX4LSB);
pub const SDL_PIXELFORMAT_INDEX4MSB = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_INDEX4MSB);
pub const SDL_PIXELFORMAT_INDEX8 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_INDEX8);
pub const SDL_PIXELFORMAT_RGB332 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGB332);
pub const SDL_PIXELFORMAT_XRGB4444 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_XRGB4444);
pub const SDL_PIXELFORMAT_RGB444 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGB444);
pub const SDL_PIXELFORMAT_XBGR4444 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_XBGR4444);
pub const SDL_PIXELFORMAT_BGR444 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGR444);
pub const SDL_PIXELFORMAT_XRGB1555 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_XRGB1555);
pub const SDL_PIXELFORMAT_RGB555 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGB555);
pub const SDL_PIXELFORMAT_XBGR1555 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_XBGR1555);
pub const SDL_PIXELFORMAT_BGR555 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGR555);
pub const SDL_PIXELFORMAT_ARGB4444 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ARGB4444);
pub const SDL_PIXELFORMAT_RGBA4444 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGBA4444);
pub const SDL_PIXELFORMAT_ABGR4444 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ABGR4444);
pub const SDL_PIXELFORMAT_BGRA4444 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGRA4444);
pub const SDL_PIXELFORMAT_ARGB1555 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ARGB1555);
pub const SDL_PIXELFORMAT_RGBA5551 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGBA5551);
pub const SDL_PIXELFORMAT_ABGR1555 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ABGR1555);
pub const SDL_PIXELFORMAT_BGRA5551 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGRA5551);
pub const SDL_PIXELFORMAT_RGB565 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGB565);
pub const SDL_PIXELFORMAT_BGR565 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGR565);
pub const SDL_PIXELFORMAT_RGB24 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGB24);
pub const SDL_PIXELFORMAT_BGR24 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGR24);
pub const SDL_PIXELFORMAT_XRGB8888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_XRGB8888);
pub const SDL_PIXELFORMAT_RGB888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGB888);
pub const SDL_PIXELFORMAT_RGBX8888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGBX8888);
pub const SDL_PIXELFORMAT_XBGR8888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_XBGR8888);
pub const SDL_PIXELFORMAT_BGR888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGR888);
pub const SDL_PIXELFORMAT_BGRX8888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGRX8888);
pub const SDL_PIXELFORMAT_ARGB8888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ARGB8888);
pub const SDL_PIXELFORMAT_RGBA8888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGBA8888);
pub const SDL_PIXELFORMAT_ABGR8888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ABGR8888);
pub const SDL_PIXELFORMAT_BGRA8888 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGRA8888);
pub const SDL_PIXELFORMAT_ARGB2101010 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ARGB2101010);
pub const SDL_PIXELFORMAT_RGBA32 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_RGBA32);
pub const SDL_PIXELFORMAT_ARGB32 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ARGB32);
pub const SDL_PIXELFORMAT_BGRA32 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_BGRA32);
pub const SDL_PIXELFORMAT_ABGR32 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_ABGR32);
pub const SDL_PIXELFORMAT_YV12 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_YV12);
pub const SDL_PIXELFORMAT_IYUV = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_IYUV);
pub const SDL_PIXELFORMAT_YUY2 = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_YUY2);
pub const SDL_PIXELFORMAT_UYVY = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_UYVY);
pub const SDL_PIXELFORMAT_YVYU = @enumToInt(enum_unnamed_34.SDL_PIXELFORMAT_YVYU);
...
pub const SDL_BLENDMODE_NONE = @enumToInt(enum_unnamed_35.SDL_BLENDMODE_NONE);
pub const SDL_BLENDMODE_BLEND = @enumToInt(enum_unnamed_35.SDL_BLENDMODE_BLEND);
pub const SDL_BLENDMODE_ADD = @enumToInt(enum_unnamed_35.SDL_BLENDMODE_ADD);
...
pub const SDL_BLENDOPERATION_ADD = @enumToInt(enum_unnamed_36.SDL_BLENDOPERATION_ADD);
pub const SDL_BLENDOPERATION_SUBTRACT = @enumToInt(enum_unnamed_36.SDL_BLENDOPERATION_SUBTRACT);
...
pub const SDL_BLENDFACTOR_ZERO = @enumToInt(enum_unnamed_37.SDL_BLENDFACTOR_ZERO);
pub const SDL_BLENDFACTOR_ONE = @enumToInt(enum_unnamed_37.SDL_BLENDFACTOR_ONE);
pub const SDL_BLENDFACTOR_SRC_COLOR = @enumToInt(enum_unnamed_37.SDL_BLENDFACTOR_SRC_COLOR);
pub const SDL_BLENDFACTOR_ONE_MINUS_SRC_COLOR = @enumToInt(enum_unnamed_37.SDL_BLENDFACTOR_ONE_MINUS_SRC_COLOR);
pub const SDL_BLENDFACTOR_SRC_ALPHA = @enumToInt(enum_unnamed_37.SDL_BLENDFACTOR_SRC_ALPHA);
pub const SDL_BLENDFACTOR_ONE_MINUS_SRC_ALPHA = @enumToInt(enum_unnamed_37.SDL_BLENDFACTOR_ONE_MINUS_SRC_ALPHA);
pub const SDL_BLENDFACTOR_DST_COLOR = @enumToInt(enum_unnamed_37.SDL_BLENDFACTOR_DST_COLOR);
...
pub const SDL_YUV_CONVERSION_JPEG = @enumToInt(enum_unnamed_38.SDL_YUV_CONVERSION_JPEG);
...
pub const SDL_WINDOW_OPENGL = @enumToInt(enum_unnamed_40.SDL_WINDOW_OPENGL);
pub const SDL_WINDOW_SHOWN = @enumToInt(enum_unnamed_40.SDL_WINDOW_SHOWN);
pub const SDL_WINDOW_HIDDEN = @enumToInt(enum_unnamed_40.SDL_WINDOW_HIDDEN);
pub const SDL_WINDOW_BORDERLESS = @enumToInt(enum_unnamed_40.SDL_WINDOW_BORDERLESS);
pub const SDL_WINDOW_RESIZABLE = @enumToInt(enum_unnamed_40.SDL_WINDOW_RESIZABLE);
pub const SDL_WINDOW_MINIMIZED = @enumToInt(enum_unnamed_40.SDL_WINDOW_MINIMIZED);
pub const SDL_WINDOW_MAXIMIZED = @enumToInt(enum_unnamed_40.SDL_WINDOW_MAXIMIZED);
pub const SDL_WINDOW_INPUT_GRABBED = @enumToInt(enum_unnamed_40.SDL_WINDOW_INPUT_GRABBED);
pub const SDL_WINDOW_INPUT_FOCUS = @enumToInt(enum_unnamed_40.SDL_WINDOW_INPUT_FOCUS);
pub const SDL_WINDOW_MOUSE_FOCUS = @enumToInt(enum_unnamed_40.SDL_WINDOW_MOUSE_FOCUS);
pub const SDL_WINDOW_FULLSCREEN_DESKTOP = @enumToInt(enum_unnamed_40.SDL_WINDOW_FULLSCREEN_DESKTOP);
pub const SDL_WINDOW_FOREIGN = @enumToInt(enum_unnamed_40.SDL_WINDOW_FOREIGN);
pub const SDL_WINDOW_ALLOW_HIGHDPI = @enumToInt(enum_unnamed_40.SDL_WINDOW_ALLOW_HIGHDPI);
pub const SDL_WINDOW_MOUSE_CAPTURE = @enumToInt(enum_unnamed_40.SDL_WINDOW_MOUSE_CAPTURE);
pub const SDL_WINDOW_ALWAYS_ON_TOP = @enumToInt(enum_unnamed_40.SDL_WINDOW_ALWAYS_ON_TOP);
pub const SDL_WINDOW_SKIP_TASKBAR = @enumToInt(enum_unnamed_40.SDL_WINDOW_SKIP_TASKBAR);
pub const SDL_WINDOW_UTILITY = @enumToInt(enum_unnamed_40.SDL_WINDOW_UTILITY);
pub const SDL_WINDOW_TOOLTIP = @enumToInt(enum_unnamed_40.SDL_WINDOW_TOOLTIP);
...
pub const SDL_WINDOWEVENT_NONE = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_NONE);
pub const SDL_WINDOWEVENT_SHOWN = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_SHOWN);
pub const SDL_WINDOWEVENT_HIDDEN = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_HIDDEN);
pub const SDL_WINDOWEVENT_EXPOSED = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_EXPOSED);
pub const SDL_WINDOWEVENT_MOVED = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_MOVED);
pub const SDL_WINDOWEVENT_RESIZED = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_RESIZED);
pub const SDL_WINDOWEVENT_SIZE_CHANGED = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_SIZE_CHANGED);
pub const SDL_WINDOWEVENT_MINIMIZED = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_MINIMIZED);
pub const SDL_WINDOWEVENT_MAXIMIZED = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_MAXIMIZED);
pub const SDL_WINDOWEVENT_RESTORED = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_RESTORED);
pub const SDL_WINDOWEVENT_ENTER = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_ENTER);
pub const SDL_WINDOWEVENT_LEAVE = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_LEAVE);
pub const SDL_WINDOWEVENT_FOCUS_GAINED = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_FOCUS_GAINED);
pub const SDL_WINDOWEVENT_FOCUS_LOST = @enumToInt(enum_unnamed_41.SDL_WINDOWEVENT_FOCUS_LOST);
...
pub const SDL_DISPLAYEVENT_NONE = @enumToInt(enum_unnamed_42.SDL_DISPLAYEVENT_NONE);
...
pub const SDL_ORIENTATION_UNKNOWN = @enumToInt(enum_unnamed_43.SDL_ORIENTATION_UNKNOWN);
pub const SDL_ORIENTATION_LANDSCAPE = @enumToInt(enum_unnamed_43.SDL_ORIENTATION_LANDSCAPE);
...
pub const SDL_GL_ALPHA_SIZE = @enumToInt(enum_unnamed_44.SDL_GL_ALPHA_SIZE);
pub const SDL_GL_BUFFER_SIZE = @enumToInt(enum_unnamed_44.SDL_GL_BUFFER_SIZE);
pub const SDL_GL_DOUBLEBUFFER = @enumToInt(enum_unnamed_44.SDL_GL_DOUBLEBUFFER);
pub const SDL_GL_DEPTH_SIZE = @enumToInt(enum_unnamed_44.SDL_GL_DEPTH_SIZE);
pub const SDL_GL_STENCIL_SIZE = @enumToInt(enum_unnamed_44.SDL_GL_STENCIL_SIZE);
pub const SDL_GL_ACCUM_RED_SIZE = @enumToInt(enum_unnamed_44.SDL_GL_ACCUM_RED_SIZE);
pub const SDL_GL_ACCUM_GREEN_SIZE = @enumToInt(enum_unnamed_44.SDL_GL_ACCUM_GREEN_SIZE);
pub const SDL_GL_ACCUM_BLUE_SIZE = @enumToInt(enum_unnamed_44.SDL_GL_ACCUM_BLUE_SIZE);
pub const SDL_GL_ACCUM_ALPHA_SIZE = @enumToInt(enum_unnamed_44.SDL_GL_ACCUM_ALPHA_SIZE);
pub const SDL_GL_STEREO = @enumToInt(enum_unnamed_44.SDL_GL_STEREO);
pub const SDL_GL_MULTISAMPLEBUFFERS = @enumToInt(enum_unnamed_44.SDL_GL_MULTISAMPLEBUFFERS);
pub const SDL_GL_MULTISAMPLESAMPLES = @enumToInt(enum_unnamed_44.SDL_GL_MULTISAMPLESAMPLES);
pub const SDL_GL_ACCELERATED_VISUAL = @enumToInt(enum_unnamed_44.SDL_GL_ACCELERATED_VISUAL);
pub const SDL_GL_RETAINED_BACKING = @enumToInt(enum_unnamed_44.SDL_GL_RETAINED_BACKING);
pub const SDL_GL_CONTEXT_MAJOR_VERSION = @enumToInt(enum_unnamed_44.SDL_GL_CONTEXT_MAJOR_VERSION);
pub const SDL_GL_CONTEXT_MINOR_VERSION = @enumToInt(enum_unnamed_44.SDL_GL_CONTEXT_MINOR_VERSION);
pub const SDL_GL_CONTEXT_EGL = @enumToInt(enum_unnamed_44.SDL_GL_CONTEXT_EGL);
pub const SDL_GL_CONTEXT_FLAGS = @enumToInt(enum_unnamed_44.SDL_GL_CONTEXT_FLAGS);
pub const SDL_GL_CONTEXT_PROFILE_MASK = @enumToInt(enum_unnamed_44.SDL_GL_CONTEXT_PROFILE_MASK);
pub const SDL_GL_SHARE_WITH_CURRENT_CONTEXT = @enumToInt(enum_unnamed_44.SDL_GL_SHARE_WITH_CURRENT_CONTEXT);
pub const SDL_GL_FRAMEBUFFER_SRGB_CAPABLE = @enumToInt(enum_unnamed_44.SDL_GL_FRAMEBUFFER_SRGB_CAPABLE);
...
pub const SDL_GL_CONTEXT_DEBUG_FLAG = @enumToInt(enum_unnamed_46.SDL_GL_CONTEXT_DEBUG_FLAG);
...
pub const SDL_HITTEST_NORMAL = @enumToInt(enum_unnamed_49.SDL_HITTEST_NORMAL);
pub const SDL_HITTEST_DRAGGABLE = @enumToInt(enum_unnamed_49.SDL_HITTEST_DRAGGABLE);
pub const SDL_HITTEST_RESIZE_TOPLEFT = @enumToInt(enum_unnamed_49.SDL_HITTEST_RESIZE_TOPLEFT);
pub const SDL_HITTEST_RESIZE_TOP = @enumToInt(enum_unnamed_49.SDL_HITTEST_RESIZE_TOP);
pub const SDL_HITTEST_RESIZE_TOPRIGHT = @enumToInt(enum_unnamed_49.SDL_HITTEST_RESIZE_TOPRIGHT);
pub const SDL_HITTEST_RESIZE_RIGHT = @enumToInt(enum_unnamed_49.SDL_HITTEST_RESIZE_RIGHT);
pub const SDL_HITTEST_RESIZE_BOTTOMRIGHT = @enumToInt(enum_unnamed_49.SDL_HITTEST_RESIZE_BOTTOMRIGHT);
...
pub const SDL_SCANCODE_UNKNOWN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_UNKNOWN);
pub const SDL_SCANCODE_A = @enumToInt(enum_unnamed_50.SDL_SCANCODE_A);
pub const SDL_SCANCODE_B = @enumToInt(enum_unnamed_50.SDL_SCANCODE_B);
pub const SDL_SCANCODE_C = @enumToInt(enum_unnamed_50.SDL_SCANCODE_C);
pub const SDL_SCANCODE_D = @enumToInt(enum_unnamed_50.SDL_SCANCODE_D);
pub const SDL_SCANCODE_E = @enumToInt(enum_unnamed_50.SDL_SCANCODE_E);
pub const SDL_SCANCODE_F = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F);
pub const SDL_SCANCODE_G = @enumToInt(enum_unnamed_50.SDL_SCANCODE_G);
pub const SDL_SCANCODE_H = @enumToInt(enum_unnamed_50.SDL_SCANCODE_H);
pub const SDL_SCANCODE_I = @enumToInt(enum_unnamed_50.SDL_SCANCODE_I);
pub const SDL_SCANCODE_J = @enumToInt(enum_unnamed_50.SDL_SCANCODE_J);
pub const SDL_SCANCODE_K = @enumToInt(enum_unnamed_50.SDL_SCANCODE_K);
pub const SDL_SCANCODE_L = @enumToInt(enum_unnamed_50.SDL_SCANCODE_L);
pub const SDL_SCANCODE_M = @enumToInt(enum_unnamed_50.SDL_SCANCODE_M);
pub const SDL_SCANCODE_N = @enumToInt(enum_unnamed_50.SDL_SCANCODE_N);
pub const SDL_SCANCODE_O = @enumToInt(enum_unnamed_50.SDL_SCANCODE_O);
pub const SDL_SCANCODE_P = @enumToInt(enum_unnamed_50.SDL_SCANCODE_P);
pub const SDL_SCANCODE_Q = @enumToInt(enum_unnamed_50.SDL_SCANCODE_Q);
pub const SDL_SCANCODE_R = @enumToInt(enum_unnamed_50.SDL_SCANCODE_R);
pub const SDL_SCANCODE_S = @enumToInt(enum_unnamed_50.SDL_SCANCODE_S);
pub const SDL_SCANCODE_T = @enumToInt(enum_unnamed_50.SDL_SCANCODE_T);
pub const SDL_SCANCODE_U = @enumToInt(enum_unnamed_50.SDL_SCANCODE_U);
pub const SDL_SCANCODE_V = @enumToInt(enum_unnamed_50.SDL_SCANCODE_V);
pub const SDL_SCANCODE_W = @enumToInt(enum_unnamed_50.SDL_SCANCODE_W);
pub const SDL_SCANCODE_X = @enumToInt(enum_unnamed_50.SDL_SCANCODE_X);
pub const SDL_SCANCODE_Y = @enumToInt(enum_unnamed_50.SDL_SCANCODE_Y);
pub const SDL_SCANCODE_Z = @enumToInt(enum_unnamed_50.SDL_SCANCODE_Z);
pub const SDL_SCANCODE_1 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_1);
pub const SDL_SCANCODE_2 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_2);
pub const SDL_SCANCODE_3 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_3);
pub const SDL_SCANCODE_4 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_4);
pub const SDL_SCANCODE_5 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_5);
pub const SDL_SCANCODE_6 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_6);
pub const SDL_SCANCODE_7 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_7);
pub const SDL_SCANCODE_8 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_8);
pub const SDL_SCANCODE_9 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_9);
pub const SDL_SCANCODE_0 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_0);
pub const SDL_SCANCODE_RETURN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_RETURN);
pub const SDL_SCANCODE_ESCAPE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_ESCAPE);
pub const SDL_SCANCODE_BACKSPACE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_BACKSPACE);
pub const SDL_SCANCODE_TAB = @enumToInt(enum_unnamed_50.SDL_SCANCODE_TAB);
pub const SDL_SCANCODE_SPACE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_SPACE);
pub const SDL_SCANCODE_MINUS = @enumToInt(enum_unnamed_50.SDL_SCANCODE_MINUS);
pub const SDL_SCANCODE_EQUALS = @enumToInt(enum_unnamed_50.SDL_SCANCODE_EQUALS);
pub const SDL_SCANCODE_LEFTBRACKET = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LEFTBRACKET);
pub const SDL_SCANCODE_RIGHTBRACKET = @enumToInt(enum_unnamed_50.SDL_SCANCODE_RIGHTBRACKET);
pub const SDL_SCANCODE_BACKSLASH = @enumToInt(enum_unnamed_50.SDL_SCANCODE_BACKSLASH);
pub const SDL_SCANCODE_NONUSHASH = @enumToInt(enum_unnamed_50.SDL_SCANCODE_NONUSHASH);
pub const SDL_SCANCODE_SEMICOLON = @enumToInt(enum_unnamed_50.SDL_SCANCODE_SEMICOLON);
pub const SDL_SCANCODE_APOSTROPHE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_APOSTROPHE);
pub const SDL_SCANCODE_GRAVE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_GRAVE);
pub const SDL_SCANCODE_COMMA = @enumToInt(enum_unnamed_50.SDL_SCANCODE_COMMA);
pub const SDL_SCANCODE_PERIOD = @enumToInt(enum_unnamed_50.SDL_SCANCODE_PERIOD);
pub const SDL_SCANCODE_SLASH = @enumToInt(enum_unnamed_50.SDL_SCANCODE_SLASH);
pub const SDL_SCANCODE_CAPSLOCK = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CAPSLOCK);
pub const SDL_SCANCODE_F1 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F1);
pub const SDL_SCANCODE_F2 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F2);
pub const SDL_SCANCODE_F3 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F3);
pub const SDL_SCANCODE_F4 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F4);
pub const SDL_SCANCODE_F5 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F5);
pub const SDL_SCANCODE_F6 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F6);
pub const SDL_SCANCODE_F7 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F7);
pub const SDL_SCANCODE_F8 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F8);
pub const SDL_SCANCODE_F9 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F9);
pub const SDL_SCANCODE_F10 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F10);
pub const SDL_SCANCODE_F11 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F11);
pub const SDL_SCANCODE_F12 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F12);
pub const SDL_SCANCODE_PRINTSCREEN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_PRINTSCREEN);
pub const SDL_SCANCODE_SCROLLLOCK = @enumToInt(enum_unnamed_50.SDL_SCANCODE_SCROLLLOCK);
pub const SDL_SCANCODE_PAUSE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_PAUSE);
pub const SDL_SCANCODE_INSERT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INSERT);
pub const SDL_SCANCODE_HOME = @enumToInt(enum_unnamed_50.SDL_SCANCODE_HOME);
pub const SDL_SCANCODE_PAGEUP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_PAGEUP);
pub const SDL_SCANCODE_DELETE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_DELETE);
pub const SDL_SCANCODE_END = @enumToInt(enum_unnamed_50.SDL_SCANCODE_END);
pub const SDL_SCANCODE_PAGEDOWN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_PAGEDOWN);
pub const SDL_SCANCODE_RIGHT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_RIGHT);
pub const SDL_SCANCODE_LEFT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LEFT);
pub const SDL_SCANCODE_DOWN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_DOWN);
pub const SDL_SCANCODE_UP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_UP);
pub const SDL_SCANCODE_NUMLOCKCLEAR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_NUMLOCKCLEAR);
pub const SDL_SCANCODE_KP_DIVIDE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_DIVIDE);
pub const SDL_SCANCODE_KP_MULTIPLY = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MULTIPLY);
pub const SDL_SCANCODE_KP_MINUS = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MINUS);
pub const SDL_SCANCODE_KP_PLUS = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_PLUS);
pub const SDL_SCANCODE_KP_ENTER = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_ENTER);
pub const SDL_SCANCODE_KP_1 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_1);
pub const SDL_SCANCODE_KP_2 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_2);
pub const SDL_SCANCODE_KP_3 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_3);
pub const SDL_SCANCODE_KP_4 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_4);
pub const SDL_SCANCODE_KP_5 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_5);
pub const SDL_SCANCODE_KP_6 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_6);
pub const SDL_SCANCODE_KP_7 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_7);
pub const SDL_SCANCODE_KP_8 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_8);
pub const SDL_SCANCODE_KP_9 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_9);
pub const SDL_SCANCODE_KP_0 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_0);
pub const SDL_SCANCODE_KP_PERIOD = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_PERIOD);
pub const SDL_SCANCODE_NONUSBACKSLASH = @enumToInt(enum_unnamed_50.SDL_SCANCODE_NONUSBACKSLASH);
pub const SDL_SCANCODE_APPLICATION = @enumToInt(enum_unnamed_50.SDL_SCANCODE_APPLICATION);
pub const SDL_SCANCODE_POWER = @enumToInt(enum_unnamed_50.SDL_SCANCODE_POWER);
pub const SDL_SCANCODE_KP_EQUALS = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_EQUALS);
pub const SDL_SCANCODE_F13 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F13);
pub const SDL_SCANCODE_F14 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F14);
pub const SDL_SCANCODE_F15 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F15);
pub const SDL_SCANCODE_F16 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F16);
pub const SDL_SCANCODE_F17 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F17);
pub const SDL_SCANCODE_F18 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F18);
pub const SDL_SCANCODE_F19 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F19);
pub const SDL_SCANCODE_F20 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F20);
pub const SDL_SCANCODE_F21 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F21);
pub const SDL_SCANCODE_F22 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F22);
pub const SDL_SCANCODE_F23 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F23);
pub const SDL_SCANCODE_F24 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_F24);
pub const SDL_SCANCODE_EXECUTE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_EXECUTE);
pub const SDL_SCANCODE_HELP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_HELP);
pub const SDL_SCANCODE_MENU = @enumToInt(enum_unnamed_50.SDL_SCANCODE_MENU);
pub const SDL_SCANCODE_SELECT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_SELECT);
pub const SDL_SCANCODE_STOP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_STOP);
pub const SDL_SCANCODE_AGAIN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AGAIN);
pub const SDL_SCANCODE_UNDO = @enumToInt(enum_unnamed_50.SDL_SCANCODE_UNDO);
pub const SDL_SCANCODE_CUT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CUT);
pub const SDL_SCANCODE_COPY = @enumToInt(enum_unnamed_50.SDL_SCANCODE_COPY);
pub const SDL_SCANCODE_PASTE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_PASTE);
pub const SDL_SCANCODE_FIND = @enumToInt(enum_unnamed_50.SDL_SCANCODE_FIND);
pub const SDL_SCANCODE_MUTE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_MUTE);
pub const SDL_SCANCODE_VOLUMEUP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_VOLUMEUP);
pub const SDL_SCANCODE_VOLUMEDOWN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_VOLUMEDOWN);
pub const SDL_SCANCODE_KP_COMMA = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_COMMA);
pub const SDL_SCANCODE_KP_EQUALSAS400 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_EQUALSAS400);
pub const SDL_SCANCODE_INTERNATIONAL1 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL1);
pub const SDL_SCANCODE_INTERNATIONAL2 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL2);
pub const SDL_SCANCODE_INTERNATIONAL3 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL3);
pub const SDL_SCANCODE_INTERNATIONAL4 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL4);
pub const SDL_SCANCODE_INTERNATIONAL5 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL5);
pub const SDL_SCANCODE_INTERNATIONAL6 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL6);
pub const SDL_SCANCODE_INTERNATIONAL7 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL7);
pub const SDL_SCANCODE_INTERNATIONAL8 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL8);
pub const SDL_SCANCODE_INTERNATIONAL9 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_INTERNATIONAL9);
pub const SDL_SCANCODE_LANG1 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG1);
pub const SDL_SCANCODE_LANG2 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG2);
pub const SDL_SCANCODE_LANG3 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG3);
pub const SDL_SCANCODE_LANG4 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG4);
pub const SDL_SCANCODE_LANG5 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG5);
pub const SDL_SCANCODE_LANG6 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG6);
pub const SDL_SCANCODE_LANG7 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG7);
pub const SDL_SCANCODE_LANG8 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG8);
pub const SDL_SCANCODE_LANG9 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LANG9);
pub const SDL_SCANCODE_ALTERASE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_ALTERASE);
pub const SDL_SCANCODE_SYSREQ = @enumToInt(enum_unnamed_50.SDL_SCANCODE_SYSREQ);
pub const SDL_SCANCODE_CANCEL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CANCEL);
pub const SDL_SCANCODE_CLEAR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CLEAR);
pub const SDL_SCANCODE_PRIOR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_PRIOR);
pub const SDL_SCANCODE_RETURN2 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_RETURN2);
pub const SDL_SCANCODE_SEPARATOR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_SEPARATOR);
pub const SDL_SCANCODE_OUT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_OUT);
pub const SDL_SCANCODE_OPER = @enumToInt(enum_unnamed_50.SDL_SCANCODE_OPER);
pub const SDL_SCANCODE_CLEARAGAIN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CLEARAGAIN);
pub const SDL_SCANCODE_CRSEL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CRSEL);
pub const SDL_SCANCODE_EXSEL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_EXSEL);
pub const SDL_SCANCODE_KP_00 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_00);
pub const SDL_SCANCODE_KP_000 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_000);
pub const SDL_SCANCODE_THOUSANDSSEPARATOR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_THOUSANDSSEPARATOR);
pub const SDL_SCANCODE_DECIMALSEPARATOR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_DECIMALSEPARATOR);
pub const SDL_SCANCODE_CURRENCYUNIT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CURRENCYUNIT);
pub const SDL_SCANCODE_CURRENCYSUBUNIT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CURRENCYSUBUNIT);
pub const SDL_SCANCODE_KP_LEFTPAREN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_LEFTPAREN);
pub const SDL_SCANCODE_KP_RIGHTPAREN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_RIGHTPAREN);
pub const SDL_SCANCODE_KP_LEFTBRACE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_LEFTBRACE);
pub const SDL_SCANCODE_KP_RIGHTBRACE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_RIGHTBRACE);
pub const SDL_SCANCODE_KP_TAB = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_TAB);
pub const SDL_SCANCODE_KP_BACKSPACE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_BACKSPACE);
pub const SDL_SCANCODE_KP_A = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_A);
pub const SDL_SCANCODE_KP_B = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_B);
pub const SDL_SCANCODE_KP_C = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_C);
pub const SDL_SCANCODE_KP_D = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_D);
pub const SDL_SCANCODE_KP_E = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_E);
pub const SDL_SCANCODE_KP_F = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_F);
pub const SDL_SCANCODE_KP_XOR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_XOR);
pub const SDL_SCANCODE_KP_POWER = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_POWER);
pub const SDL_SCANCODE_KP_PERCENT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_PERCENT);
pub const SDL_SCANCODE_KP_LESS = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_LESS);
pub const SDL_SCANCODE_KP_GREATER = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_GREATER);
pub const SDL_SCANCODE_KP_AMPERSAND = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_AMPERSAND);
pub const SDL_SCANCODE_KP_DBLAMPERSAND = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_DBLAMPERSAND);
pub const SDL_SCANCODE_KP_VERTICALBAR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_VERTICALBAR);
pub const SDL_SCANCODE_KP_DBLVERTICALBAR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_DBLVERTICALBAR);
pub const SDL_SCANCODE_KP_COLON = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_COLON);
pub const SDL_SCANCODE_KP_HASH = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_HASH);
pub const SDL_SCANCODE_KP_SPACE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_SPACE);
pub const SDL_SCANCODE_KP_AT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_AT);
pub const SDL_SCANCODE_KP_EXCLAM = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_EXCLAM);
pub const SDL_SCANCODE_KP_MEMSTORE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MEMSTORE);
pub const SDL_SCANCODE_KP_MEMRECALL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MEMRECALL);
pub const SDL_SCANCODE_KP_MEMCLEAR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MEMCLEAR);
pub const SDL_SCANCODE_KP_MEMADD = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MEMADD);
pub const SDL_SCANCODE_KP_MEMSUBTRACT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MEMSUBTRACT);
pub const SDL_SCANCODE_KP_MEMMULTIPLY = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MEMMULTIPLY);
pub const SDL_SCANCODE_KP_MEMDIVIDE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_MEMDIVIDE);
pub const SDL_SCANCODE_KP_PLUSMINUS = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_PLUSMINUS);
pub const SDL_SCANCODE_KP_CLEAR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_CLEAR);
pub const SDL_SCANCODE_KP_CLEARENTRY = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_CLEARENTRY);
pub const SDL_SCANCODE_KP_BINARY = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_BINARY);
pub const SDL_SCANCODE_KP_OCTAL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_OCTAL);
pub const SDL_SCANCODE_KP_DECIMAL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_DECIMAL);
pub const SDL_SCANCODE_KP_HEXADECIMAL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KP_HEXADECIMAL);
pub const SDL_SCANCODE_LCTRL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LCTRL);
pub const SDL_SCANCODE_LSHIFT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LSHIFT);
pub const SDL_SCANCODE_LALT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LALT);
pub const SDL_SCANCODE_LGUI = @enumToInt(enum_unnamed_50.SDL_SCANCODE_LGUI);
pub const SDL_SCANCODE_RCTRL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_RCTRL);
pub const SDL_SCANCODE_RSHIFT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_RSHIFT);
pub const SDL_SCANCODE_RALT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_RALT);
pub const SDL_SCANCODE_RGUI = @enumToInt(enum_unnamed_50.SDL_SCANCODE_RGUI);
pub const SDL_SCANCODE_MODE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_MODE);
pub const SDL_SCANCODE_AUDIONEXT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AUDIONEXT);
pub const SDL_SCANCODE_AUDIOPREV = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AUDIOPREV);
pub const SDL_SCANCODE_AUDIOSTOP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AUDIOSTOP);
pub const SDL_SCANCODE_AUDIOPLAY = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AUDIOPLAY);
pub const SDL_SCANCODE_AUDIOMUTE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AUDIOMUTE);
pub const SDL_SCANCODE_MEDIASELECT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_MEDIASELECT);
pub const SDL_SCANCODE_WWW = @enumToInt(enum_unnamed_50.SDL_SCANCODE_WWW);
pub const SDL_SCANCODE_MAIL = @enumToInt(enum_unnamed_50.SDL_SCANCODE_MAIL);
pub const SDL_SCANCODE_CALCULATOR = @enumToInt(enum_unnamed_50.SDL_SCANCODE_CALCULATOR);
pub const SDL_SCANCODE_COMPUTER = @enumToInt(enum_unnamed_50.SDL_SCANCODE_COMPUTER);
pub const SDL_SCANCODE_AC_SEARCH = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AC_SEARCH);
pub const SDL_SCANCODE_AC_HOME = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AC_HOME);
pub const SDL_SCANCODE_AC_BACK = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AC_BACK);
pub const SDL_SCANCODE_AC_FORWARD = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AC_FORWARD);
pub const SDL_SCANCODE_AC_STOP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AC_STOP);
pub const SDL_SCANCODE_AC_REFRESH = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AC_REFRESH);
pub const SDL_SCANCODE_AC_BOOKMARKS = @enumToInt(enum_unnamed_50.SDL_SCANCODE_AC_BOOKMARKS);
pub const SDL_SCANCODE_BRIGHTNESSDOWN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_BRIGHTNESSDOWN);
pub const SDL_SCANCODE_BRIGHTNESSUP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_BRIGHTNESSUP);
pub const SDL_SCANCODE_DISPLAYSWITCH = @enumToInt(enum_unnamed_50.SDL_SCANCODE_DISPLAYSWITCH);
pub const SDL_SCANCODE_KBDILLUMTOGGLE = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KBDILLUMTOGGLE);
pub const SDL_SCANCODE_KBDILLUMDOWN = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KBDILLUMDOWN);
pub const SDL_SCANCODE_KBDILLUMUP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_KBDILLUMUP);
pub const SDL_SCANCODE_EJECT = @enumToInt(enum_unnamed_50.SDL_SCANCODE_EJECT);
pub const SDL_SCANCODE_SLEEP = @enumToInt(enum_unnamed_50.SDL_SCANCODE_SLEEP);
pub const SDL_SCANCODE_APP1 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_APP1);
pub const SDL_SCANCODE_APP2 = @enumToInt(enum_unnamed_50.SDL_SCANCODE_APP2);
...
pub const SDLK_UNKNOWN = @enumToInt(enum_unnamed_51.SDLK_UNKNOWN);
pub const SDLK_RETURN = @enumToInt(enum_unnamed_51.SDLK_RETURN);
pub const SDLK_ESCAPE = @enumToInt(enum_unnamed_51.SDLK_ESCAPE);
pub const SDLK_BACKSPACE = @enumToInt(enum_unnamed_51.SDLK_BACKSPACE);
pub const SDLK_TAB = @enumToInt(enum_unnamed_51.SDLK_TAB);
pub const SDLK_SPACE = @enumToInt(enum_unnamed_51.SDLK_SPACE);
pub const SDLK_EXCLAIM = @enumToInt(enum_unnamed_51.SDLK_EXCLAIM);
pub const SDLK_QUOTEDBL = @enumToInt(enum_unnamed_51.SDLK_QUOTEDBL);
pub const SDLK_HASH = @enumToInt(enum_unnamed_51.SDLK_HASH);
pub const SDLK_PERCENT = @enumToInt(enum_unnamed_51.SDLK_PERCENT);
pub const SDLK_DOLLAR = @enumToInt(enum_unnamed_51.SDLK_DOLLAR);
pub const SDLK_AMPERSAND = @enumToInt(enum_unnamed_51.SDLK_AMPERSAND);
pub const SDLK_QUOTE = @enumToInt(enum_unnamed_51.SDLK_QUOTE);
pub const SDLK_LEFTPAREN = @enumToInt(enum_unnamed_51.SDLK_LEFTPAREN);
pub const SDLK_RIGHTPAREN = @enumToInt(enum_unnamed_51.SDLK_RIGHTPAREN);
pub const SDLK_ASTERISK = @enumToInt(enum_unnamed_51.SDLK_ASTERISK);
pub const SDLK_PLUS = @enumToInt(enum_unnamed_51.SDLK_PLUS);
pub const SDLK_COMMA = @enumToInt(enum_unnamed_51.SDLK_COMMA);
pub const SDLK_MINUS = @enumToInt(enum_unnamed_51.SDLK_MINUS);
pub const SDLK_PERIOD = @enumToInt(enum_unnamed_51.SDLK_PERIOD);
pub const SDLK_SLASH = @enumToInt(enum_unnamed_51.SDLK_SLASH);
pub const SDLK_0 = @enumToInt(enum_unnamed_51.SDLK_0);
pub const SDLK_1 = @enumToInt(enum_unnamed_51.SDLK_1);
pub const SDLK_2 = @enumToInt(enum_unnamed_51.SDLK_2);
pub const SDLK_3 = @enumToInt(enum_unnamed_51.SDLK_3);
pub const SDLK_4 = @enumToInt(enum_unnamed_51.SDLK_4);
pub const SDLK_5 = @enumToInt(enum_unnamed_51.SDLK_5);
pub const SDLK_6 = @enumToInt(enum_unnamed_51.SDLK_6);
pub const SDLK_7 = @enumToInt(enum_unnamed_51.SDLK_7);
pub const SDLK_8 = @enumToInt(enum_unnamed_51.SDLK_8);
pub const SDLK_9 = @enumToInt(enum_unnamed_51.SDLK_9);
pub const SDLK_COLON = @enumToInt(enum_unnamed_51.SDLK_COLON);
pub const SDLK_SEMICOLON = @enumToInt(enum_unnamed_51.SDLK_SEMICOLON);
pub const SDLK_LESS = @enumToInt(enum_unnamed_51.SDLK_LESS);
pub const SDLK_EQUALS = @enumToInt(enum_unnamed_51.SDLK_EQUALS);
pub const SDLK_GREATER = @enumToInt(enum_unnamed_51.SDLK_GREATER);
pub const SDLK_QUESTION = @enumToInt(enum_unnamed_51.SDLK_QUESTION);
pub const SDLK_AT = @enumToInt(enum_unnamed_51.SDLK_AT);
pub const SDLK_LEFTBRACKET = @enumToInt(enum_unnamed_51.SDLK_LEFTBRACKET);
pub const SDLK_BACKSLASH = @enumToInt(enum_unnamed_51.SDLK_BACKSLASH);
pub const SDLK_RIGHTBRACKET = @enumToInt(enum_unnamed_51.SDLK_RIGHTBRACKET);
pub const SDLK_CARET = @enumToInt(enum_unnamed_51.SDLK_CARET);
pub const SDLK_UNDERSCORE = @enumToInt(enum_unnamed_51.SDLK_UNDERSCORE);
pub const SDLK_BACKQUOTE = @enumToInt(enum_unnamed_51.SDLK_BACKQUOTE);
pub const SDLK_a = @enumToInt(enum_unnamed_51.SDLK_a);
pub const SDLK_b = @enumToInt(enum_unnamed_51.SDLK_b);
pub const SDLK_c = @enumToInt(enum_unnamed_51.SDLK_c);
pub const SDLK_d = @enumToInt(enum_unnamed_51.SDLK_d);
pub const SDLK_e = @enumToInt(enum_unnamed_51.SDLK_e);
pub const SDLK_f = @enumToInt(enum_unnamed_51.SDLK_f);
pub const SDLK_g = @enumToInt(enum_unnamed_51.SDLK_g);
pub const SDLK_h = @enumToInt(enum_unnamed_51.SDLK_h);
pub const SDLK_i = @enumToInt(enum_unnamed_51.SDLK_i);
pub const SDLK_j = @enumToInt(enum_unnamed_51.SDLK_j);
pub const SDLK_k = @enumToInt(enum_unnamed_51.SDLK_k);
pub const SDLK_l = @enumToInt(enum_unnamed_51.SDLK_l);
pub const SDLK_m = @enumToInt(enum_unnamed_51.SDLK_m);
pub const SDLK_n = @enumToInt(enum_unnamed_51.SDLK_n);
pub const SDLK_o = @enumToInt(enum_unnamed_51.SDLK_o);
pub const SDLK_p = @enumToInt(enum_unnamed_51.SDLK_p);
pub const SDLK_q = @enumToInt(enum_unnamed_51.SDLK_q);
pub const SDLK_r = @enumToInt(enum_unnamed_51.SDLK_r);
pub const SDLK_s = @enumToInt(enum_unnamed_51.SDLK_s);
pub const SDLK_t = @enumToInt(enum_unnamed_51.SDLK_t);
pub const SDLK_u = @enumToInt(enum_unnamed_51.SDLK_u);
pub const SDLK_v = @enumToInt(enum_unnamed_51.SDLK_v);
pub const SDLK_w = @enumToInt(enum_unnamed_51.SDLK_w);
pub const SDLK_x = @enumToInt(enum_unnamed_51.SDLK_x);
pub const SDLK_y = @enumToInt(enum_unnamed_51.SDLK_y);
pub const SDLK_z = @enumToInt(enum_unnamed_51.SDLK_z);
pub const SDLK_CAPSLOCK = @enumToInt(enum_unnamed_51.SDLK_CAPSLOCK);
pub const SDLK_F1 = @enumToInt(enum_unnamed_51.SDLK_F1);
pub const SDLK_F2 = @enumToInt(enum_unnamed_51.SDLK_F2);
pub const SDLK_F3 = @enumToInt(enum_unnamed_51.SDLK_F3);
pub const SDLK_F4 = @enumToInt(enum_unnamed_51.SDLK_F4);
pub const SDLK_F5 = @enumToInt(enum_unnamed_51.SDLK_F5);
pub const SDLK_F6 = @enumToInt(enum_unnamed_51.SDLK_F6);
pub const SDLK_F7 = @enumToInt(enum_unnamed_51.SDLK_F7);
pub const SDLK_F8 = @enumToInt(enum_unnamed_51.SDLK_F8);
pub const SDLK_F9 = @enumToInt(enum_unnamed_51.SDLK_F9);
pub const SDLK_F10 = @enumToInt(enum_unnamed_51.SDLK_F10);
pub const SDLK_F11 = @enumToInt(enum_unnamed_51.SDLK_F11);
pub const SDLK_F12 = @enumToInt(enum_unnamed_51.SDLK_F12);
pub const SDLK_PRINTSCREEN = @enumToInt(enum_unnamed_51.SDLK_PRINTSCREEN);
pub const SDLK_SCROLLLOCK = @enumToInt(enum_unnamed_51.SDLK_SCROLLLOCK);
pub const SDLK_PAUSE = @enumToInt(enum_unnamed_51.SDLK_PAUSE);
pub const SDLK_INSERT = @enumToInt(enum_unnamed_51.SDLK_INSERT);
pub const SDLK_HOME = @enumToInt(enum_unnamed_51.SDLK_HOME);
pub const SDLK_PAGEUP = @enumToInt(enum_unnamed_51.SDLK_PAGEUP);
pub const SDLK_DELETE = @enumToInt(enum_unnamed_51.SDLK_DELETE);
pub const SDLK_END = @enumToInt(enum_unnamed_51.SDLK_END);
pub const SDLK_PAGEDOWN = @enumToInt(enum_unnamed_51.SDLK_PAGEDOWN);
pub const SDLK_RIGHT = @enumToInt(enum_unnamed_51.SDLK_RIGHT);
pub const SDLK_LEFT = @enumToInt(enum_unnamed_51.SDLK_LEFT);
pub const SDLK_DOWN = @enumToInt(enum_unnamed_51.SDLK_DOWN);
pub const SDLK_UP = @enumToInt(enum_unnamed_51.SDLK_UP);
pub const SDLK_NUMLOCKCLEAR = @enumToInt(enum_unnamed_51.SDLK_NUMLOCKCLEAR);
pub const SDLK_KP_DIVIDE = @enumToInt(enum_unnamed_51.SDLK_KP_DIVIDE);
pub const SDLK_KP_MULTIPLY = @enumToInt(enum_unnamed_51.SDLK_KP_MULTIPLY);
pub const SDLK_KP_MINUS = @enumToInt(enum_unnamed_51.SDLK_KP_MINUS);
pub const SDLK_KP_PLUS = @enumToInt(enum_unnamed_51.SDLK_KP_PLUS);
pub const SDLK_KP_ENTER = @enumToInt(enum_unnamed_51.SDLK_KP_ENTER);
pub const SDLK_KP_1 = @enumToInt(enum_unnamed_51.SDLK_KP_1);
pub const SDLK_KP_2 = @enumToInt(enum_unnamed_51.SDLK_KP_2);
pub const SDLK_KP_3 = @enumToInt(enum_unnamed_51.SDLK_KP_3);
pub const SDLK_KP_4 = @enumToInt(enum_unnamed_51.SDLK_KP_4);
pub const SDLK_KP_5 = @enumToInt(enum_unnamed_51.SDLK_KP_5);
pub const SDLK_KP_6 = @enumToInt(enum_unnamed_51.SDLK_KP_6);
pub const SDLK_KP_7 = @enumToInt(enum_unnamed_51.SDLK_KP_7);
pub const SDLK_KP_8 = @enumToInt(enum_unnamed_51.SDLK_KP_8);
pub const SDLK_KP_9 = @enumToInt(enum_unnamed_51.SDLK_KP_9);
pub const SDLK_KP_0 = @enumToInt(enum_unnamed_51.SDLK_KP_0);
pub const SDLK_KP_PERIOD = @enumToInt(enum_unnamed_51.SDLK_KP_PERIOD);
pub const SDLK_APPLICATION = @enumToInt(enum_unnamed_51.SDLK_APPLICATION);
pub const SDLK_POWER = @enumToInt(enum_unnamed_51.SDLK_POWER);
pub const SDLK_KP_EQUALS = @enumToInt(enum_unnamed_51.SDLK_KP_EQUALS);
pub const SDLK_F13 = @enumToInt(enum_unnamed_51.SDLK_F13);
pub const SDLK_F14 = @enumToInt(enum_unnamed_51.SDLK_F14);
pub const SDLK_F15 = @enumToInt(enum_unnamed_51.SDLK_F15);
pub const SDLK_F16 = @enumToInt(enum_unnamed_51.SDLK_F16);
pub const SDLK_F17 = @enumToInt(enum_unnamed_51.SDLK_F17);
pub const SDLK_F18 = @enumToInt(enum_unnamed_51.SDLK_F18);
pub const SDLK_F19 = @enumToInt(enum_unnamed_51.SDLK_F19);
pub const SDLK_F20 = @enumToInt(enum_unnamed_51.SDLK_F20);
pub const SDLK_F21 = @enumToInt(enum_unnamed_51.SDLK_F21);
pub const SDLK_F22 = @enumToInt(enum_unnamed_51.SDLK_F22);
pub const SDLK_F23 = @enumToInt(enum_unnamed_51.SDLK_F23);
pub const SDLK_F24 = @enumToInt(enum_unnamed_51.SDLK_F24);
pub const SDLK_EXECUTE = @enumToInt(enum_unnamed_51.SDLK_EXECUTE);
pub const SDLK_HELP = @enumToInt(enum_unnamed_51.SDLK_HELP);
pub const SDLK_MENU = @enumToInt(enum_unnamed_51.SDLK_MENU);
pub const SDLK_SELECT = @enumToInt(enum_unnamed_51.SDLK_SELECT);
pub const SDLK_STOP = @enumToInt(enum_unnamed_51.SDLK_STOP);
pub const SDLK_AGAIN = @enumToInt(enum_unnamed_51.SDLK_AGAIN);
pub const SDLK_UNDO = @enumToInt(enum_unnamed_51.SDLK_UNDO);
pub const SDLK_CUT = @enumToInt(enum_unnamed_51.SDLK_CUT);
pub const SDLK_COPY = @enumToInt(enum_unnamed_51.SDLK_COPY);
pub const SDLK_PASTE = @enumToInt(enum_unnamed_51.SDLK_PASTE);
pub const SDLK_FIND = @enumToInt(enum_unnamed_51.SDLK_FIND);
pub const SDLK_MUTE = @enumToInt(enum_unnamed_51.SDLK_MUTE);
pub const SDLK_VOLUMEUP = @enumToInt(enum_unnamed_51.SDLK_VOLUMEUP);
pub const SDLK_VOLUMEDOWN = @enumToInt(enum_unnamed_51.SDLK_VOLUMEDOWN);
pub const SDLK_KP_COMMA = @enumToInt(enum_unnamed_51.SDLK_KP_COMMA);
pub const SDLK_KP_EQUALSAS400 = @enumToInt(enum_unnamed_51.SDLK_KP_EQUALSAS400);
pub const SDLK_ALTERASE = @enumToInt(enum_unnamed_51.SDLK_ALTERASE);
pub const SDLK_SYSREQ = @enumToInt(enum_unnamed_51.SDLK_SYSREQ);
pub const SDLK_CANCEL = @enumToInt(enum_unnamed_51.SDLK_CANCEL);
pub const SDLK_CLEAR = @enumToInt(enum_unnamed_51.SDLK_CLEAR);
pub const SDLK_PRIOR = @enumToInt(enum_unnamed_51.SDLK_PRIOR);
pub const SDLK_RETURN2 = @enumToInt(enum_unnamed_51.SDLK_RETURN2);
pub const SDLK_SEPARATOR = @enumToInt(enum_unnamed_51.SDLK_SEPARATOR);
pub const SDLK_OUT = @enumToInt(enum_unnamed_51.SDLK_OUT);
pub const SDLK_OPER = @enumToInt(enum_unnamed_51.SDLK_OPER);
pub const SDLK_CLEARAGAIN = @enumToInt(enum_unnamed_51.SDLK_CLEARAGAIN);
pub const SDLK_CRSEL = @enumToInt(enum_unnamed_51.SDLK_CRSEL);
pub const SDLK_EXSEL = @enumToInt(enum_unnamed_51.SDLK_EXSEL);
pub const SDLK_KP_00 = @enumToInt(enum_unnamed_51.SDLK_KP_00);
pub const SDLK_KP_000 = @enumToInt(enum_unnamed_51.SDLK_KP_000);
pub const SDLK_THOUSANDSSEPARATOR = @enumToInt(enum_unnamed_51.SDLK_THOUSANDSSEPARATOR);
pub const SDLK_DECIMALSEPARATOR = @enumToInt(enum_unnamed_51.SDLK_DECIMALSEPARATOR);
pub const SDLK_CURRENCYUNIT = @enumToInt(enum_unnamed_51.SDLK_CURRENCYUNIT);
pub const SDLK_CURRENCYSUBUNIT = @enumToInt(enum_unnamed_51.SDLK_CURRENCYSUBUNIT);
pub const SDLK_KP_LEFTPAREN = @enumToInt(enum_unnamed_51.SDLK_KP_LEFTPAREN);
pub const SDLK_KP_RIGHTPAREN = @enumToInt(enum_unnamed_51.SDLK_KP_RIGHTPAREN);
pub const SDLK_KP_LEFTBRACE = @enumToInt(enum_unnamed_51.SDLK_KP_LEFTBRACE);
pub const SDLK_KP_RIGHTBRACE = @enumToInt(enum_unnamed_51.SDLK_KP_RIGHTBRACE);
pub const SDLK_KP_TAB = @enumToInt(enum_unnamed_51.SDLK_KP_TAB);
pub const SDLK_KP_BACKSPACE = @enumToInt(enum_unnamed_51.SDLK_KP_BACKSPACE);
pub const SDLK_KP_A = @enumToInt(enum_unnamed_51.SDLK_KP_A);
pub const SDLK_KP_B = @enumToInt(enum_unnamed_51.SDLK_KP_B);
pub const SDLK_KP_C = @enumToInt(enum_unnamed_51.SDLK_KP_C);
pub const SDLK_KP_D = @enumToInt(enum_unnamed_51.SDLK_KP_D);
pub const SDLK_KP_E = @enumToInt(enum_unnamed_51.SDLK_KP_E);
pub const SDLK_KP_F = @enumToInt(enum_unnamed_51.SDLK_KP_F);
pub const SDLK_KP_XOR = @enumToInt(enum_unnamed_51.SDLK_KP_XOR);
pub const SDLK_KP_POWER = @enumToInt(enum_unnamed_51.SDLK_KP_POWER);
pub const SDLK_KP_PERCENT = @enumToInt(enum_unnamed_51.SDLK_KP_PERCENT);
pub const SDLK_KP_LESS = @enumToInt(enum_unnamed_51.SDLK_KP_LESS);
pub const SDLK_KP_GREATER = @enumToInt(enum_unnamed_51.SDLK_KP_GREATER);
pub const SDLK_KP_AMPERSAND = @enumToInt(enum_unnamed_51.SDLK_KP_AMPERSAND);
pub const SDLK_KP_DBLAMPERSAND = @enumToInt(enum_unnamed_51.SDLK_KP_DBLAMPERSAND);
pub const SDLK_KP_VERTICALBAR = @enumToInt(enum_unnamed_51.SDLK_KP_VERTICALBAR);
pub const SDLK_KP_DBLVERTICALBAR = @enumToInt(enum_unnamed_51.SDLK_KP_DBLVERTICALBAR);
pub const SDLK_KP_COLON = @enumToInt(enum_unnamed_51.SDLK_KP_COLON);
pub const SDLK_KP_HASH = @enumToInt(enum_unnamed_51.SDLK_KP_HASH);
pub const SDLK_KP_SPACE = @enumToInt(enum_unnamed_51.SDLK_KP_SPACE);
pub const SDLK_KP_AT = @enumToInt(enum_unnamed_51.SDLK_KP_AT);
pub const SDLK_KP_EXCLAM = @enumToInt(enum_unnamed_51.SDLK_KP_EXCLAM);
pub const SDLK_KP_MEMSTORE = @enumToInt(enum_unnamed_51.SDLK_KP_MEMSTORE);
pub const SDLK_KP_MEMRECALL = @enumToInt(enum_unnamed_51.SDLK_KP_MEMRECALL);
pub const SDLK_KP_MEMCLEAR = @enumToInt(enum_unnamed_51.SDLK_KP_MEMCLEAR);
pub const SDLK_KP_MEMADD = @enumToInt(enum_unnamed_51.SDLK_KP_MEMADD);
pub const SDLK_KP_MEMSUBTRACT = @enumToInt(enum_unnamed_51.SDLK_KP_MEMSUBTRACT);
pub const SDLK_KP_MEMMULTIPLY = @enumToInt(enum_unnamed_51.SDLK_KP_MEMMULTIPLY);
pub const SDLK_KP_MEMDIVIDE = @enumToInt(enum_unnamed_51.SDLK_KP_MEMDIVIDE);
pub const SDLK_KP_PLUSMINUS = @enumToInt(enum_unnamed_51.SDLK_KP_PLUSMINUS);
pub const SDLK_KP_CLEAR = @enumToInt(enum_unnamed_51.SDLK_KP_CLEAR);
pub const SDLK_KP_CLEARENTRY = @enumToInt(enum_unnamed_51.SDLK_KP_CLEARENTRY);
pub const SDLK_KP_BINARY = @enumToInt(enum_unnamed_51.SDLK_KP_BINARY);
pub const SDLK_KP_OCTAL = @enumToInt(enum_unnamed_51.SDLK_KP_OCTAL);
pub const SDLK_KP_DECIMAL = @enumToInt(enum_unnamed_51.SDLK_KP_DECIMAL);
pub const SDLK_KP_HEXADECIMAL = @enumToInt(enum_unnamed_51.SDLK_KP_HEXADECIMAL);
pub const SDLK_LCTRL = @enumToInt(enum_unnamed_51.SDLK_LCTRL);
pub const SDLK_LSHIFT = @enumToInt(enum_unnamed_51.SDLK_LSHIFT);
pub const SDLK_LALT = @enumToInt(enum_unnamed_51.SDLK_LALT);
pub const SDLK_LGUI = @enumToInt(enum_unnamed_51.SDLK_LGUI);
pub const SDLK_RCTRL = @enumToInt(enum_unnamed_51.SDLK_RCTRL);
pub const SDLK_RSHIFT = @enumToInt(enum_unnamed_51.SDLK_RSHIFT);
pub const SDLK_RALT = @enumToInt(enum_unnamed_51.SDLK_RALT);
pub const SDLK_RGUI = @enumToInt(enum_unnamed_51.SDLK_RGUI);
pub const SDLK_MODE = @enumToInt(enum_unnamed_51.SDLK_MODE);
pub const SDLK_AUDIONEXT = @enumToInt(enum_unnamed_51.SDLK_AUDIONEXT);
pub const SDLK_AUDIOPREV = @enumToInt(enum_unnamed_51.SDLK_AUDIOPREV);
pub const SDLK_AUDIOSTOP = @enumToInt(enum_unnamed_51.SDLK_AUDIOSTOP);
pub const SDLK_AUDIOPLAY = @enumToInt(enum_unnamed_51.SDLK_AUDIOPLAY);
pub const SDLK_AUDIOMUTE = @enumToInt(enum_unnamed_51.SDLK_AUDIOMUTE);
pub const SDLK_MEDIASELECT = @enumToInt(enum_unnamed_51.SDLK_MEDIASELECT);
pub const SDLK_WWW = @enumToInt(enum_unnamed_51.SDLK_WWW);
pub const SDLK_MAIL = @enumToInt(enum_unnamed_51.SDLK_MAIL);
pub const SDLK_CALCULATOR = @enumToInt(enum_unnamed_51.SDLK_CALCULATOR);
pub const SDLK_COMPUTER = @enumToInt(enum_unnamed_51.SDLK_COMPUTER);
pub const SDLK_AC_SEARCH = @enumToInt(enum_unnamed_51.SDLK_AC_SEARCH);
pub const SDLK_AC_HOME = @enumToInt(enum_unnamed_51.SDLK_AC_HOME);
pub const SDLK_AC_BACK = @enumToInt(enum_unnamed_51.SDLK_AC_BACK);
pub const SDLK_AC_FORWARD = @enumToInt(enum_unnamed_51.SDLK_AC_FORWARD);
pub const SDLK_AC_STOP = @enumToInt(enum_unnamed_51.SDLK_AC_STOP);
pub const SDLK_AC_REFRESH = @enumToInt(enum_unnamed_51.SDLK_AC_REFRESH);
pub const SDLK_AC_BOOKMARKS = @enumToInt(enum_unnamed_51.SDLK_AC_BOOKMARKS);
pub const SDLK_BRIGHTNESSDOWN = @enumToInt(enum_unnamed_51.SDLK_BRIGHTNESSDOWN);
pub const SDLK_BRIGHTNESSUP = @enumToInt(enum_unnamed_51.SDLK_BRIGHTNESSUP);
pub const SDLK_DISPLAYSWITCH = @enumToInt(enum_unnamed_51.SDLK_DISPLAYSWITCH);
pub const SDLK_KBDILLUMTOGGLE = @enumToInt(enum_unnamed_51.SDLK_KBDILLUMTOGGLE);
pub const SDLK_KBDILLUMDOWN = @enumToInt(enum_unnamed_51.SDLK_KBDILLUMDOWN);
pub const SDLK_KBDILLUMUP = @enumToInt(enum_unnamed_51.SDLK_KBDILLUMUP);
pub const SDLK_EJECT = @enumToInt(enum_unnamed_51.SDLK_EJECT);
pub const SDLK_SLEEP = @enumToInt(enum_unnamed_51.SDLK_SLEEP);
pub const SDLK_APP1 = @enumToInt(enum_unnamed_51.SDLK_APP1);
...
pub const KMOD_NONE = @enumToInt(enum_unnamed_52.KMOD_NONE);
pub const KMOD_LSHIFT = @enumToInt(enum_unnamed_52.KMOD_LSHIFT);
pub const KMOD_RSHIFT = @enumToInt(enum_unnamed_52.KMOD_RSHIFT);
pub const KMOD_LCTRL = @enumToInt(enum_unnamed_52.KMOD_LCTRL);
pub const KMOD_RCTRL = @enumToInt(enum_unnamed_52.KMOD_RCTRL);
pub const KMOD_LALT = @enumToInt(enum_unnamed_52.KMOD_LALT);
pub const KMOD_RALT = @enumToInt(enum_unnamed_52.KMOD_RALT);
pub const KMOD_LGUI = @enumToInt(enum_unnamed_52.KMOD_LGUI);
pub const KMOD_RGUI = @enumToInt(enum_unnamed_52.KMOD_RGUI);
pub const KMOD_NUM = @enumToInt(enum_unnamed_52.KMOD_NUM);
pub const KMOD_CAPS = @enumToInt(enum_unnamed_52.KMOD_CAPS);
pub const KMOD_MODE = @enumToInt(enum_unnamed_52.KMOD_MODE);
pub const KMOD_RESERVED = @enumToInt(enum_unnamed_52.KMOD_RESERVED);
pub const KMOD_CTRL = @enumToInt(enum_unnamed_52.KMOD_CTRL);
...
pub const SDL_SYSTEM_CURSOR_ARROW = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_ARROW);
pub const SDL_SYSTEM_CURSOR_IBEAM = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_IBEAM);
pub const SDL_SYSTEM_CURSOR_WAIT = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_WAIT);
pub const SDL_SYSTEM_CURSOR_CROSSHAIR = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_CROSSHAIR);
pub const SDL_SYSTEM_CURSOR_WAITARROW = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_WAITARROW);
pub const SDL_SYSTEM_CURSOR_SIZENWSE = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_SIZENWSE);
pub const SDL_SYSTEM_CURSOR_SIZENESW = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_SIZENESW);
pub const SDL_SYSTEM_CURSOR_SIZEWE = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_SIZEWE);
pub const SDL_SYSTEM_CURSOR_SIZENS = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_SIZENS);
pub const SDL_SYSTEM_CURSOR_SIZEALL = @enumToInt(enum_unnamed_53.SDL_SYSTEM_CURSOR_SIZEALL);
...
pub const SDL_JOYSTICK_TYPE_WHEEL = @enumToInt(enum_unnamed_56.SDL_JOYSTICK_TYPE_WHEEL);
pub const SDL_JOYSTICK_TYPE_ARCADE_STICK = @enumToInt(enum_unnamed_56.SDL_JOYSTICK_TYPE_ARCADE_STICK);
pub const SDL_JOYSTICK_TYPE_FLIGHT_STICK = @enumToInt(enum_unnamed_56.SDL_JOYSTICK_TYPE_FLIGHT_STICK);
pub const SDL_JOYSTICK_TYPE_DANCE_PAD = @enumToInt(enum_unnamed_56.SDL_JOYSTICK_TYPE_DANCE_PAD);
pub const SDL_JOYSTICK_TYPE_GUITAR = @enumToInt(enum_unnamed_56.SDL_JOYSTICK_TYPE_GUITAR);
...
pub const SDL_CONTROLLER_BUTTON_MISC1 = @enumToInt(enum_unnamed_63.SDL_CONTROLLER_BUTTON_MISC1);
pub const SDL_CONTROLLER_BUTTON_PADDLE1 = @enumToInt(enum_unnamed_63.SDL_CONTROLLER_BUTTON_PADDLE1);
pub const SDL_CONTROLLER_BUTTON_PADDLE2 = @enumToInt(enum_unnamed_63.SDL_CONTROLLER_BUTTON_PADDLE2);
...
pub const SDL_LOCALECHANGED = @enumToInt(enum_unnamed_65.SDL_LOCALECHANGED);
...
pub inline fn SDL_FOURCC(A: anytype, B: anytype, C: anytype, D: anytype) @TypeOf((((SDL_static_cast(Uint32, SDL_static_cast(Uint8, A)) << 0) | (SDL_static_cast(Uint32, SDL_static_cast(Uint8, B)) << 8)) | (SDL_static_cast(Uint32, SDL_static_cast(Uint8, C)) << 16)) | (SDL_static_cast(Uint32, SDL_static_cast(Uint8, D)) << 24)) {
...
pub inline fn SDL_iconv_utf8_ucs2(S: anytype) @TypeOf((@import("std").meta.cast([*c]Uint16, SDL_iconv_string("UCS-2-INTERNAL", "UTF-8", S, SDL_strlen(S) + 1)))) {
    return (@import("std").meta.cast([*c]Uint16, SDL_iconv_string("UCS-2-INTERNAL", "UTF-8", S, SDL_strlen(S) + 1)));
}
pub inline fn SDL_iconv_utf8_ucs4(S: anytype) @TypeOf((@import("std").meta.cast([*c]Uint32, SDL_iconv_string("UCS-4-INTERNAL", "UTF-8", S, SDL_strlen(S) + 1)))) {
...
pub inline fn SDL_TICKS_PASSED(A: anytype, B: anytype) @TypeOf((@import("std").meta.cast(Sint32, B - A)) <= 0) {
